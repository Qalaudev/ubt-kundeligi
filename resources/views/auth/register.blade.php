...
<head>
    ...
    <title>Тіркелу - Тест Басқару</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-lg p-6 md:p-8">
            <h1 class="text-2xl md:text-3xl font-bold text-center mb-6 text-gray-800">Тіркелу</h1>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-1">Құпия Сөзді Растау</label>
                    <input 
                        type="password" 
                        ...
                        placeholder="Құпия сөзіңізді растаңыз"
                    >
                </div>

                <button 
                    type="submit" 
                    class="w-full bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors font-medium"
                >
                    Тіркелу
                </button>
            </form>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Тіркелгіңіз бар ма? 
                    <a href="{{ route('login') }}" class="text-blue-500 hover:text-blue-600 font-medium">Мұнда кіріңіз</a>
                </p>
            </div>
